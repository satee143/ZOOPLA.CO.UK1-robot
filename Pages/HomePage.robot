...
Storing Properties in List
    ...
    ${Prop_Count}    Get Element Count    ${Retrive_Data_Xpath}
    @{MyList}=    Create List
...
#### DISPLAY THE PROPERTY VALUES IN THE  LIST    
Displaying the Property List
    [Documentation]    Storing the Property Values in the List
    ${Mylist}    Storing Properties in List
...
Comparing The Seller with Property
    ...
    ${Seller_Real_Name}    Get Text    xpath:(//*[@id]/div/div[2]/h2/a)[1]
    Log To Console    Property Name in Seller Page is :${Seller_Real_Name}
    #Should Be Equal    ${Seller_Name}    ${Seller_Real_Name}
